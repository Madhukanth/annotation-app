...
import InteractiveCircle from '@renderer/components/shapes/InteractiveCircle'
...
type CircleShapeProps = { imgSize: ImgSize; selectCommentTab: () => void }
const CircleShape: FC<CircleShapeProps> = ({ imgSize, selectCommentTab }) => {
