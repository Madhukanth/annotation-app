...
import InteractiveRectangle from '@renderer/components/shapes/InteractiveRectangle'
...
type RectangleShapeProps = { imgSize: ImgSize; selectCommentTab: () => void }
const RectangleShape: FC<RectangleShapeProps> = ({ imgSize, selectCommentTab }) => {
