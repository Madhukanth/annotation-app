...
import {
  ...
  AnnotationTabs,
  useImageStore,
  useImageUntrackedStore
} from '@/features/image-annotation'
...
import AnnotateSidebar from '@/features/image-annotation/components/AnnotateSidebar'
  ...
  const completeShape = (
    ...
    if (newPolyIdRef.current) {
      const finishedPolygon = updatePolygon(newPolyIdRef.current, {
        name,
        notes,
        stroke: strokeColor || selectedColor,
        classId,
        attribute,
        text,
        ID
