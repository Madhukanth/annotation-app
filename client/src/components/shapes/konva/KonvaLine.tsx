...
type LineProps = {
  ...
  onSelect: () => void
  onChange: (shapeProps: LineType) => void
  onPointClick: ({ lineId, pointId }: { lineId: string; pointId: string }) => void
  selectedPointId: string | null
}

const KonvaLine: FC<LineProps> = ({
  stageRef,
  shapeProps,
  isSelected,
  onSelect,
  ...
  const onCircleClick = (pointId: PointType['id']) => (e: KonvaEventObject<MouseEvent>) => {
    e.cancelBubble = true
    onPointClick({ lineId: shapeProps.id, pointId })
  }
